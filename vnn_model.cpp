...
vsi_nn_graph_t * vnn_CreateModel
    (
    char * data_file_name,
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Reshape_MADNet/tf.image.resize_4/resize/ResizeBilinear/out0_0:out0 */
    attr.size[0] = 1;
    attr.size[1] = 640;
    attr.size[2] = 480;
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 85.95304107666016;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.007150000426918268;
